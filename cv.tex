...
\section{About me}
\cvitem{}{
	I am a technically curious software developer with 10+ years of professional experience. I enjoy expanding my horizon whether that would be learning a new language, using a new tool, or tackling an unknown domain. Professional growth is a huge motivator in my day to day work life.
	\newline I firmly believe in using the right tool for the job at hand, that testing is a core part of software development and that the best solutions are crafted through dialog and sparring. The importance of semantics is a pet peeve of mine.
	\newline I live in Østbirk, near Skanderborg, with my wife and our two children, ages 8 and 6. In my spare time I enjoy playing board games, brewing beer, and dabbling in game development.
}
\clearpage
\end{document}
